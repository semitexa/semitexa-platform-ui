...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-platform-ui/security/advisories/new).
...
- **Email** — `support@semitexa.com`. Put "security" and the package name
  (`semitexa/platform-ui`) in the subject.
...
In scope: anything in `semitexa/platform-ui` that lets a request, a job or a message do
